...
import 'package:keshav_s_application2/presentation/notification_tray/notification_tray_screen.dart';
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 20),
                  CustomPaint(size: Size(280, 2), painter: CurvePainter()),
                  InkWell(
                    onTap: () {
                      ...
                      child: Row(
                        children: [
                          ...
                          IconBadge(
                            ...
                            itemCount: widget.inboxCount == null
                                ? 0
                                : widget.inboxCount,
                  ...
                  InkWell(
                    onTap: () {
                      Navigator.of(context).push(
                        MaterialPageRoute(
                          builder: (_) => const NotificationTrayScreen(),
                        ),
                      );
                    },
                    child: Container(
                  ...
                  InkWell(
                    onTap: () {
                      Navigator.of(context).push(
                        MaterialPageRoute(builder: (context) => BlogsScreen1()),
                      );
                    },
                    child: Container(
                      width: 75.w,
