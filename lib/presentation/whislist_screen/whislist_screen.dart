            ...
            appBar: CustomAppBar(
                ...
                actions: [
                  Container(
                      ...
                      margin:
                          getMargin(left: 12, top: 30, right: 12, bottom: 10),
              ...
              child: FutureBuilder(
                ...
                builder: (context,snapshot){
                  if (snapshot.hasData){
                            ...
                            child: Column(
                                ...
                                children: [
                                  ...
                                  Padding(
                                      ...
                                      child: Row(children: [
                                        ...
                                        Padding(
                                            ...
                                            child: Text(wishlistdata.length.toString()+" PRODUCTS",
                                  ...
                                  Align(
                                      ...
                                      child: Padding(
                                          padding: getPadding(left: 21, top: 19, right: 20),
                    ...
                    return Center(
                        child: Image(image: AssetImage("assets/images/wishlist_empty.png"),filterQuality: FilterQuality.high,width: 200,height: 200,
                        ));
                  }
                  else{
                    return const Center(
