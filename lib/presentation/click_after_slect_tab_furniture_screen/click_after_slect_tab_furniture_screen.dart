...
class ClickAfterSlectTabFurnitureScreen extends StatefulWidget {
  ...
  ClickAfterSlectTabFurnitureScreen(this.data,this.category,this.category_name);
  @override
  State<ClickAfterSlectTabFurnitureScreen> createState() => _ClickAfterSlectTabFurnitureScreenState();
}

class _ClickAfterSlectTabFurnitureScreenState extends State<ClickAfterSlectTabFurnitureScreen> {
  ...
  Future<sub.CategorySubcategory> getSubCategory() async {
    ...
    var response =
    await dio.Dio().post("https://fabfurni.com/api/Webservice/category_subcategory",
        options: dio.Options(
          headers: {
