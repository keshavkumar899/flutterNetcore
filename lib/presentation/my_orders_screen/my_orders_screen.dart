...
import 'package:keshav_s_application2/presentation/my_orders_screen/models/my_orders_model.dart' as orders;
              ...
              child:
                ...
                Padding(
                    ...
                    child: Row(
                        ...
                        children: [
                          Padding(
                              padding: getPadding(top: 20, left: 15, bottom: 8),
                              child: Text("You've placed "+orderslist.length.toString()+" orders",
                                  overflow: TextOverflow.ellipsis,
                                  textAlign: TextAlign.left,
                                  style: AppStyle.txtRobotoRegular14Purple30001
                                      .copyWith(
                                          letterSpacing:
                            ...
                            return ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  return SingleChildScrollView(
                                    child: Container(
                                        margin: getMargin(left: 11, top: 23, right: 11),
                                        decoration: AppDecoration.outlineBlack900191
                                            .copyWith(
                                            borderRadius:
                                            BorderRadiusStyle.customBorderBR51),
                                        child: Column(
