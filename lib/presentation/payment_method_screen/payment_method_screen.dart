...
class PaymentMethodScreen extends StatefulWidget {
  ...
  String mrp_price;
  Data data;
  PaymentMethodScreen(this.count,this.total_amount,this.address_id,this.address1,this.address2,this.product_id,this.userid,this.discount_price,this.mrp_price,this.data);
  @override
...
class _PaymentMethodScreenState extends State<PaymentMethodScreen> {
  ...
  Future<void> _handlePaymentSuccess(PaymentSuccessResponse response) async {
    ...
    Navigator.pushReplacement(context, MaterialPageRoute(builder: (BuildContext context) => OrderPlacedScreen(widget.total_amount,widget.address_id,widget.address1,widget.address2,widget.product_id,widget.userid,response.paymentId.toString(),widget.discount_price,widget.mrp_price,widget.data,'1')));
